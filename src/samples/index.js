...
const WeightedList = require('./weighted_list')
const RandomList = require('./random_list')
const RandomSample = require('./random_sample')
const IpGenerator = require('./ip_generator')
...
sets.astronauts = new RandomList(require('./astronauts').map(name =>
...
module.exports = _.mapValues(sets, set => (
  typeof set === 'function'
    ? set
    : () => set.get()
))
